...
echo r18b-arm-22
ndk=r18b arch=arm api=22 bash single_round.sh &> r18b-arm-22.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r18b-arm-23
...
echo r18b-arm-27
ndk=r18b arch=arm api=27 bash single_round.sh &> r18b-arm-27.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r18b-arm-28
ndk=r18b arch=arm api=28 bash single_round.sh &> r18b-arm-28.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r18b-arm64-28
ndk=r18b arch=arm64 api=28 bash single_round.sh &> r18b-arm64-28.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r18b-x86_64-28
ndk=r18b arch=x86_64 api=28 bash single_round.sh &> r18b-x86_64-28.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
...
echo r17c-arm-26
ndk=r17c arch=arm api=26 bash single_round.sh &> r17c-arm-26.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r17c-arm-27
ndk=r17c arch=arm api=27 bash single_round.sh &> r17c-arm-27.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r17c-arm-28
