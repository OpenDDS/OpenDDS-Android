...
echo r12b-arm-21
ndk=r12b arch=arm api=21 bash single_round.sh &> r12b-arm-21.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r12b-arm-24
ndk=r12b arch=arm api=24 bash single_round.sh &> r12b-arm-24.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
