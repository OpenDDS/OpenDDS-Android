...
# r20 ========================================
ndk=r20 bash get_ndk.sh
echo r20-arm-16
ndk=r20 arch=arm api=16 bash single_round.sh &> r20-arm-16.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-17
ndk=r20 arch=arm api=17 bash single_round.sh &> r20-arm-17.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-18
ndk=r20 arch=arm api=18 bash single_round.sh &> r20-arm-18.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-19
ndk=r20 arch=arm api=19 bash single_round.sh &> r20-arm-19.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-21
ndk=r20 arch=arm api=21 bash single_round.sh &> r20-arm-21.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-22
ndk=r20 arch=arm api=22 bash single_round.sh &> r20-arm-22.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-23
ndk=r20 arch=arm api=23 bash single_round.sh &> r20-arm-23.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-24
ndk=r20 arch=arm api=24 bash single_round.sh &> r20-arm-24.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-26
ndk=r20 arch=arm api=26 bash single_round.sh &> r20-arm-26.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-27
ndk=r20 arch=arm api=27 bash single_round.sh &> r20-arm-27.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-28
ndk=r20 arch=arm api=28 bash single_round.sh &> r20-arm-28.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm-29
ndk=r20 arch=arm api=29 bash single_round.sh &> r20-arm-29.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-arm64-29
ndk=r20 arch=arm64 api=29 bash single_round.sh &> r20-arm64-29.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
echo r20-x86_64-29
ndk=r20 arch=x86_64 api=29 bash single_round.sh &> r20-x86_64-29.log || (echo FAIL; bash rm_toolchain.sh; exit 0)
ndk=r20 bash rm_ndk.sh
# r19c ========================================
